...
public class LithicClaimsCommandsOld
{
...
//    }
    ...
    public static void register(CommandDispatcher<CommandSourceStack> dispatcher)
    {
        ...
        claimCommand.then(claimCommandRemove.then(Commands.argument("location", BlockPosArgument.blockPos()).executes(LithicClaimsCommandsOld::executeClaimRemove)));
        claimCommand.then(claimCommandInfo.then(Commands.argument("location", BlockPosArgument.blockPos()).executes(LithicClaimsCommandsOld::executeClaimInfo)));
        claimCommand.then(claimCommandList.executes(LithicClaimsCommandsOld::executeListClaims));
        ...
        claimCommand.then(claimCommandModify.then(Commands.argument("location", BlockPosArgument.blockPos()).then(claimCommandModifyOwner.then(Commands.argument("name | uuid", StringArgumentType.string()).executes(LithicClaimsCommandsOld::executeClaimModifyOwner)))));
        claimCommand.then(claimCommandModify.then(Commands.argument("location", BlockPosArgument.blockPos()).then(claimCommandModifyArea.then(Commands.argument("radius", IntegerArgumentType.integer(0, 128)).executes(LithicClaimsCommandsOld::executeClaimModifyArea)))));
        ...
        teamCommand.then(teamCommandCreate.then(Commands.argument("name", StringArgumentType.string()).then(Commands.argument("stance", StringArgumentType.string()).then(Commands.argument("colour", IntegerArgumentType.integer(0, 16777215)).executes(LithicClaimsCommandsOld::executeTeamCreate)))));
//        teamCommand.then(teamCommandRelations.then(Commands.argument("name | uuid", StringArgumentType.string()).then(Commands.argument("stance", StringArgumentType.string()).executes(LithicClaimsCommands::executeTeamRelations))));
        teamCommand.then(teamCommandKick.then(Commands.argument("name | uuid", StringArgumentType.string()).then(Commands.argument("player", EntityArgument.player()).executes(LithicClaimsCommandsOld::executeTeamKick))));
        teamCommand.then(teamCommandResetCooldown.then(Commands.argument("name | uuid", StringArgumentType.string()).executes(LithicClaimsCommandsOld::executeTeamResetCooldown)));
        teamCommand.then(teamCommandDisband.then(Commands.argument("name | uuid", StringArgumentType.string()).executes(LithicClaimsCommandsOld::executeTeamDisband)));
        teamCommand.then(teamCommandInfo.then(Commands.argument("name | uuid", StringArgumentType.string()).executes(LithicClaimsCommandsOld::executeTeamInfo)));
        teamCommand.then(teamCommandList.executes(LithicClaimsCommandsOld::executeListTeams));
        teamCommand.then(teamCommandLeave.executes(LithicClaimsCommandsOld::executeTeamLeave));
        ...
        teamCommandModify.then(Commands.argument("name | uuid", StringArgumentType.string()).then(teamCommandModifyLeader.then(Commands.argument("player", EntityArgument.player()).executes(LithicClaimsCommandsOld::executeTeamModifyLeader))));
        teamCommandModify.then(Commands.argument("name | uuid", StringArgumentType.string()).then(teamCommandModifyName.then(Commands.argument("name", StringArgumentType.string()).executes(LithicClaimsCommandsOld::executeTeamModifyName))));
        teamCommandModify.then(Commands.argument("name | uuid", StringArgumentType.string()).then(teamCommandModifyStance.then(Commands.argument("stance", StringArgumentType.string()).executes(LithicClaimsCommandsOld::executeTeamModifyStance))));
        teamCommandModify.then(Commands.argument("name | uuid", StringArgumentType.string()).then(teamCommandModifyColour.then(Commands.argument("colour", IntegerArgumentType.integer(0, 16777215)).executes(LithicClaimsCommandsOld::executeTeamModifyColour))));
